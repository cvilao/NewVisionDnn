...
class Image:
    def __init__(self):
        ...
        self.capture.set(3,1280) #720 1280 1920
        self.capture.set(4,720) #480 720 1080
...
#                resampled_particle += sp[0][i]*(sp[1]*N)
            resampled_particle += [sp[0]]*(sp[1]*float(N))
...
def showImage(particles,img):
    ...
    #Precisa girar en torno do eixo y flipmode =1, pois o sistema de coordenadas é diferente de part e a imagem de destino.
    cv2.flip(dst,1)
